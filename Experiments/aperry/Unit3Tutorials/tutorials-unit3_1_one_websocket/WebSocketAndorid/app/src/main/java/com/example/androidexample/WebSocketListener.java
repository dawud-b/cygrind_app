 ...
 * including typing indicator updates.
 */
public interface WebSocketListener {
    ...
    /**
     * Called when a typing status update is received from another user.
     *
     * @param username The username of the user whose typing status changed
     * @param isTyping True if the user is typing, false otherwise
     */
    void onTypingStatusUpdate(String username, boolean isTyping);
}