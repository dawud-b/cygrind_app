...
public class ImageUploadActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Add a toast to inform users
        Toast.makeText(getApplicationContext(), "You can select images including GIFs", Toast.LENGTH_SHORT).show();
                ...
                uri -> {
                    ...
                    if (uri != null) {
                        ...
                        if (mimeType != null && mimeType.equals("image/gif")) {
                            Log.d("ImageUpload", "GIF selected");
                            Toast.makeText(getApplicationContext(), "GIF selected", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
